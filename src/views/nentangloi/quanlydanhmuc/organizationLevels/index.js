...
const ListOrganizationlevels = () => {
  ...
  const SignupSchema = yup.object().shape({
    groupName: yup.string().required("Vui lòng nhập tên cấp đơn vị"),
  ...
  const handleDelete = (key) => {
    deleteOrganizationLevel(key)
      .then((res) => {
        MySwal.fire({
          title: "Xóa cấp đơn vị thành công",
          icon: "success",
          customClass: {
    ...
    },
    {
      ...
      render: (record) => (
        <div style={{ display: "flex", justifyContent: "center" }}>
          {ability.can('update', 'DM_CAP_DON_VI') &&
            <>
              <EditOutlined
          ...
          {ability.can('delete', 'DM_CAP_DON_VI') &&
            <Popconfirm
  ...
  return (
    ...
    >
      <Row style={{ justifyContent: "space-between" }}>
        ...
        {ability.can('create', 'DM_CAP_DON_VI') &&
...
export default ListOrganizationlevels 
