...
const AddNewModal = ({ open, handleModal, getData, listGroup, listStatus, currentPage, rowsPerPage }) => {
          ...
          <Row className="content-space-between">
            <div className="mb-1 col col-6">
              <Label className="form-label" for="react-select">
                Chọn nhóm người dùng<span className="redColor">(*)</span>
              </Label>
              <Controller
                id="react-select"
                control={control}
                ...
                render={({ field }) => (
                  <Select
                    ...
                    className={classnames('react-select', { 'is-invalid': errors.userGroupID })}
                    {...field}
              ...
              />
              {errors.userGroupID && (
                <FormFeedback>Vui lòng chọn nhóm người dùng</FormFeedback>
              )}
            </div>
            <div className="mb-1 col col-6">
              <Label className="form-label" for="react-select">
